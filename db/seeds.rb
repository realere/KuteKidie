...
babysitter_image = [File.open(File.join(Rails.root, "db/seed_images/black-young-lady1.jpg")), File.open(File.join(Rails.root"db/seed_images/black-young-lady2.jpg"]
...
prng = Random.new
 ...
 #  end
  ...
  b.babysitter_image = babysitter_image[rand(babysitter_image.length)]
  b.save
